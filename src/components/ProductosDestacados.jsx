...
export default function ProductosDestacados() {
  return (
    <section className="p-5 text-black bg-teal-400">
      <h2 className="text-4xl font-bold text-center mb-8 text-white" >Nuestros Productos Destacados</h2>
        ...
        {productosDestacados.map((producto) => (
          <div key={producto.id}
            ...
            <NavLink to="/productos"
              className="mt-3 px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-green-700 hover:cursor-pointer transition inline-block text-center">
              Comprar
            </NavLink>
          </div>
        ))}
